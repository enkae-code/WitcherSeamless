...
namespace scripting
{
    namespace
    {
        ...
        game::CFunction* allocate_cfunction(int name_id, game::script_function* function)
        {
            ...
            using CFunction_ctor_ptr = game::CFunction* (*)(game::CFunction*, int*, game::script_function*);
            auto* CFunction_ctor = reinterpret_cast<CFunction_ctor_ptr>(0x1413DB730_g);
        ...
        void script_w3m_send_attack(game::script_execution_context& ctx)
        {
            ...
            // Read arguments in reverse order from script stack
            detail::read_script_argument(ctx, &attack_type);
